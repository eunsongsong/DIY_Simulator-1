...
public class CropImageOptions implements Parcelable {
  ...
  public static final Creator<com.example.diy_simulator.CropImageOptions> CREATOR =
      new Creator<com.example.diy_simulator.CropImageOptions>() {
        @Override
        public com.example.diy_simulator.CropImageOptions createFromParcel(Parcel in) {
          return new com.example.diy_simulator.CropImageOptions(in);
        }

        @Override
        public com.example.diy_simulator.CropImageOptions[] newArray(int size) {
          return new com.example.diy_simulator.CropImageOptions[size];
        }
      };
