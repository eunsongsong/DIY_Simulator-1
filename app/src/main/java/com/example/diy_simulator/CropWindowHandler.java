...
import com.example.diy_simulator.CropWindowMoveHandler;
...
final class CropWindowHandler {
  ...
  private CropWindowMoveHandler.Type getRectanglePressedMoveType(
    ...
    if (com.example.diy_simulator.CropWindowHandler.isInCornerTargetZone(x, y, mEdges.left, mEdges.top, targetRadius)) {
      moveType = CropWindowMoveHandler.Type.TOP_LEFT;
    } else if (com.example.diy_simulator.CropWindowHandler.isInCornerTargetZone(
    ...
    } else if (com.example.diy_simulator.CropWindowHandler.isInCenterTargetZone(
            x, y, mEdges.left, mEdges.top, mEdges.right, mEdges.bottom)
        && focusCenter()) {
      moveType = CropWindowMoveHandler.Type.CENTER;
    } else if (com.example.diy_simulator.CropWindowHandler.isInHorizontalTargetZone(
    ...
    } else if (com.example.diy_simulator.CropWindowHandler.isInVerticalTargetZone(
