...
final class BitmapLoadingWorkerTask extends AsyncTask<Void, Void, com.example.diy_simulator.BitmapLoadingWorkerTask.Result> {
  ...
  protected Result doInBackground(Void... params) {
    try {
      if (!isCancelled()) {
        ...
        com.example.diy_simulator.BitmapUtils.BitmapSampled decodeResult =
            com.example.diy_simulator.BitmapUtils.decodeSampledBitmap(mContext, mUri, mWidth, mHeight);

        if (!isCancelled()) {

          com.example.diy_simulator.BitmapUtils.RotateBitmapResult rotateResult =
              com.example.diy_simulator.BitmapUtils.rotateBitmapByExif(decodeResult.bitmap, mContext, mUri);
