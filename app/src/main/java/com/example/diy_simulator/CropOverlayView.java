...
public class CropOverlayView extends View {
  ...
  public void resetCropOverlayView() {
    if (initializedCropWindow) {
      setCropWindowRect(com.example.diy_simulator.BitmapUtils.EMPTY_RECT_F);
      initCropWindow();
      invalidate();
    }
  }
  ...
  public void setInitialCropWindowRect(Rect rect) {
    mInitialCropWindowRect.set(rect != null ? rect : com.example.diy_simulator.BitmapUtils.EMPTY_RECT);
    if (initializedCropWindow) {
      initCropWindow();
      invalidate();
  ...
  private void initCropWindow() {
    ...
    float leftLimit = Math.max(com.example.diy_simulator.BitmapUtils.getRectLeft(mBoundsPoints), 0);
    float topLimit = Math.max(com.example.diy_simulator.BitmapUtils.getRectTop(mBoundsPoints), 0);
    float rightLimit = Math.min(com.example.diy_simulator.BitmapUtils.getRectRight(mBoundsPoints), getWidth());
    float bottomLimit = Math.min(com.example.diy_simulator.BitmapUtils.getRectBottom(mBoundsPoints), getHeight());
  ...
  private void drawBackground(Canvas canvas) {
    ...
    float left = Math.max(com.example.diy_simulator.BitmapUtils.getRectLeft(mBoundsPoints), 0);
    float top = Math.max(com.example.diy_simulator.BitmapUtils.getRectTop(mBoundsPoints), 0);
    float right = Math.min(com.example.diy_simulator.BitmapUtils.getRectRight(mBoundsPoints), getWidth());
    float bottom = Math.min(com.example.diy_simulator.BitmapUtils.getRectBottom(mBoundsPoints), getHeight());
  ...
  private boolean calculateBounds(RectF rect) {
    ...
    float left = com.example.diy_simulator.BitmapUtils.getRectLeft(mBoundsPoints);
    float top = com.example.diy_simulator.BitmapUtils.getRectTop(mBoundsPoints);
    float right = com.example.diy_simulator.BitmapUtils.getRectRight(mBoundsPoints);
    float bottom = com.example.diy_simulator.BitmapUtils.getRectBottom(mBoundsPoints);
