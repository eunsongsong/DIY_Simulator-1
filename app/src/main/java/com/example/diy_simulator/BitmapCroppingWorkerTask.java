...
final class BitmapCroppingWorkerTask
    extends AsyncTask<Void, Void, com.example.diy_simulator.BitmapCroppingWorkerTask.Result> {
   ...
   */
  @Override
  protected com.example.diy_simulator.BitmapCroppingWorkerTask.Result doInBackground(Void... params) {
    try {
      if (!isCancelled()) {
