...
import com.example.diy_simulator.CropImageActivity;
import com.example.diy_simulator.CropImageOptions;
import com.example.diy_simulator.CropImageView;
...
public final class CropImage {
    ...
    public static Intent getPickImageChooserIntent(@NonNull Context context) {
        return getPickImageChooserIntent(
                context, context.getString(com.example.diy_simulator.R.string.pick_image_intent_chooser_title), false, true);
    }
    ...
    /**
     * Create {@link com.example.diy_simulator.CropImage.ActivityBuilder} instance to open image picker for cropping and then start {@link
     ...
     */
    public static com.example.diy_simulator.CropImage.ActivityBuilder activity() {
        return new com.example.diy_simulator.CropImage.ActivityBuilder(null);
    }

    /**
     * Create {@link com.example.diy_simulator.CropImage.ActivityBuilder} instance to start {@link CropImageActivity} to crop the given
     * image.<br>
     * Result will be received in {@link Activity#onActivityResult(int, int, Intent)} and can be
     * retrieved using {@link #getActivityResult(Intent)}.
     *
     ...
     * @return builder for Crop Image Activity
     */
    public static com.example.diy_simulator.CropImage.ActivityBuilder activity(@Nullable Uri uri) {
        return new com.example.diy_simulator.CropImage.ActivityBuilder(uri);
    }
     ...
     */
    public static com.example.diy_simulator.CropImage.ActivityResult getActivityResult(@Nullable Intent data) {
        return data != null ? (com.example.diy_simulator.CropImage.ActivityResult) data.getParcelableExtra(CROP_IMAGE_EXTRA_RESULT) : null;
    }
    ...
    public static final class ActivityBuilder {
        ...
        public Intent getIntent(@NonNull Context context, @Nullable Class<?> cls) {
            ...
            intent.putExtra(com.example.diy_simulator.CropImage.CROP_IMAGE_EXTRA_BUNDLE, bundle);
            return intent;
        }
         ...
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setCropShape(@NonNull CropImageView.CropShape cropShape) {
         ...
         * <i>Default: 3dp</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setSnapRadius(float snapRadius) {
         ...
         * <i>Default: 48dp</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setTouchRadius(float touchRadius) {
         ...
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setGuidelines(@NonNull CropImageView.Guidelines guidelines) {
         ...
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setScaleType(@NonNull CropImageView.ScaleType scaleType) {
         ...
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setShowCropOverlay(boolean showCropOverlay) {
         ...
         * default: true.
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setAutoZoomEnabled(boolean autoZoomEnabled) {
         ...
         * default: true.
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setMultiTouchEnabled(boolean multiTouchEnabled) {
         ...
         * <i>Default: 4</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setMaxZoom(int maxZoom) {
         ...
         * <i>Default: 0.1</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setInitialCropWindowPaddingRatio(float initialCropWindowPaddingRatio) {
         ...
         * <i>Default: false</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setFixAspectRatio(boolean fixAspectRatio) {
         ...
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setAspectRatio(int aspectRatioX, int aspectRatioY) {
         ...
         * <i>Default: 3dp</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setBorderLineThickness(float borderLineThickness) {
         ...
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setBorderLineColor(int borderLineColor) {
         ...
         * <i>Default: 2dp</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setBorderCornerThickness(float borderCornerThickness) {
         ...
         * <i>Default: 5dp</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setBorderCornerOffset(float borderCornerOffset) {
         ...
         * <i>Default: 14dp</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setBorderCornerLength(float borderCornerLength) {
         ...
         * <i>Default: WHITE</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setBorderCornerColor(int borderCornerColor) {
         ...
         * <i>Default: 1dp</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setGuidelinesThickness(float guidelinesThickness) {
         ...
         * <i>Default: Color.argb(170, 255, 255, 255)</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setGuidelinesColor(int guidelinesColor) {
         ...
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setBackgroundColor(int backgroundColor) {
         ...
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setMinCropWindowSize(int minCropWindowWidth, int minCropWindowHeight) {
         ...
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setMinCropResultSize(int minCropResultWidth, int minCropResultHeight) {
         ...
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setMaxCropResultSize(int maxCropResultWidth, int maxCropResultHeight) {
         ...
         * <i>Default: ""</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setActivityTitle(CharSequence activityTitle) {
         ...
         * <i>Default: NONE</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setActivityMenuIconColor(int activityMenuIconColor) {
         ...
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setOutputUri(Uri outputUri) {
         ...
         * <i>Default: JPEG</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setOutputCompressFormat(Bitmap.CompressFormat outputCompressFormat) {
         ...
         * <i>Default: 90</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setOutputCompressQuality(int outputCompressQuality) {
         ...
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setRequestedSize(int reqWidth, int reqHeight) {
         ...
         * <i>Default: 0, 0 - not set, will not resize</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setRequestedSize(
         ...
         * <i>Default: false</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setNoOutputImage(boolean noOutputImage) {
         ...
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setInitialCropWindowRectangle(Rect initialCropWindowRectangle) {
         ...
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setInitialRotation(int initialRotation) {
         ...
         * <i>Default: true</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setAllowRotation(boolean allowRotation) {
         ...
         * <i>Default: true</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setAllowFlipping(boolean allowFlipping) {
         ...
         * <i>Default: false</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setAllowCounterRotation(boolean allowCounterRotation) {
         ...
         * <i>Default: 90</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setRotationDegrees(int rotationDegrees) {
         ...
         * <i>Default: false</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setFlipHorizontally(boolean flipHorizontally) {
         ...
         * <i>Default: false</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setFlipVertically(boolean flipVertically) {
         ...
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setCropMenuCropButtonTitle(CharSequence title) {
         ...
         * <i>Default: 0</i>
         */
        public com.example.diy_simulator.CropImage.ActivityBuilder setCropMenuCropButtonIcon(@DrawableRes int drawableResource) {
    ...
    public static final class ActivityResult extends CropImageView.CropResult implements Parcelable {
        ...
        public static final Creator<com.example.diy_simulator.CropImage.ActivityResult> CREATOR =
                new Creator<com.example.diy_simulator.CropImage.ActivityResult>() {
                    @Override
                    public com.example.diy_simulator.CropImage.ActivityResult createFromParcel(Parcel in) {
                        return new com.example.diy_simulator.CropImage.ActivityResult(in);
                    }

                    @Override
                    public com.example.diy_simulator.CropImage.ActivityResult[] newArray(int size) {
                        return new com.example.diy_simulator.CropImage.ActivityResult[size];
                    }
                };
